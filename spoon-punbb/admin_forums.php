						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td><textarea name="forum_desc" rows="3" cols="30" tabindex="2"><?php echo pun_htmlspecialchars($cur_forum['forum_desc']) ?></textarea></td>
								</tr>
								<tr>
...
?>
								...
								<tr>
									...
									<td><?php echo ($cur_forum['num_topics']) ? 'Only available in empty forums' : '<input type="text" name="redirect_url" size="30" maxlength="100" value="'.pun_htmlspecialchars($cur_forum['redirect_url']).'" tabindex="5" />'; ?></td>
								</tr>
							</table>
						</div>
					</fieldset>
