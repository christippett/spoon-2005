...
$smiley_text = array(':)', ':v', ':(', ':D', ':eek:', ':o:', ';)',  ':mad:', ':rolleye:', ':cool:');
$smiley_img = array('smile.gif', 'v.gif', 'sad.gif', 'big_smile.gif', 'eek.gif', 'embarassed.gif', 'wink.gif', 'mad.gif', 'roll.gif', 'cool.gif');
