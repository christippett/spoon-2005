						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								<tr>
									...
									<td>
										<input type="text" name="form[board_title]" size="30" maxlength="255" value="<?php echo pun_htmlspecialchars($pun_config['o_board_title']) ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="form[board_desc]" size="30" maxlength="255" value="<?php echo pun_htmlspecialchars($pun_config['o_board_desc']) ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="form[base_url]" size="30" maxlength="100" value="<?php echo $pun_config['o_base_url'] ?>" />
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										<textarea name="form[additional_navlinks]" rows="3" cols="30"><?php echo pun_htmlspecialchars($pun_config['o_additional_navlinks']) ?></textarea>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										<textarea name="form[mailing_list]" rows="5" cols="30"><?php echo pun_htmlspecialchars($pun_config['o_mailing_list']) ?></textarea>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								<tr>
									...
									<td>
										<input type="text" name="form[admin_email]" size="30" maxlength="50" value="<?php echo $pun_config['o_admin_email'] ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="form[webmaster_email]" size="30" maxlength="50" value="<?php echo $pun_config['o_webmaster_email'] ?>" />
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										<textarea name="form[rules_message]" rows="10" cols="30"><?php echo pun_htmlspecialchars($pun_config['o_rules_message']) ?></textarea>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										<textarea name="form[announcement_message]" rows="5" cols="30"><?php echo pun_htmlspecialchars($pun_config['o_announcement_message']) ?></textarea>
						...
						<div class="infldset">
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										<textarea name="form[maintenance_message]" rows="5" cols="30"><?php echo pun_htmlspecialchars($pun_config['o_maintenance_message']) ?></textarea>
