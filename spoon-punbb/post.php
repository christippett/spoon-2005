...
<div class="linkst" style="margin-top: 0px;">
	<div class="inbox">
		<ul><li><a href="forum.php"><?php echo $lang_common['Index'] ?></a></li><li>&nbsp;-&nbsp;<?php echo $forum_name ?><?php if (isset($cur_posting['subject'])) echo '</li><li>&nbsp;&raquo;&nbsp;'.pun_htmlspecialchars($cur_posting['subject']) ?></li></ul>
	</div>
</div>
