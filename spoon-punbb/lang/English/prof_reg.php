...
'Domain reserved'			=> 'The domain you entered has been reserved by a SPOON account. Please go back and try again.',
'Domain check failed'		=> 'SPOON was unable to determine the status of the domain.',
'Domain registered'			=> 'The domain you entered is unavailable. Please go back and try again.',
'Empty domain'				=> 'You must enter a domain.',
'Domain format'				=> 'The domain you entered is contains illegal characters. Please go back and correct.',

'Empty fname'				=> 'You must enter a first name.',
'Empty lname'				=> 'You must enter a last name.',
'Empty address1'			=> 'You must enter an address.',
'Empty city'				=> 'You must enter a city.'
);
