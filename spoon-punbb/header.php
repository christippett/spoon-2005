...
// START SUBST - <spoon_header>
$tmp_header = '<div id="headerimg"><img src="/images/top.gif" alt="SPOON Hosting" /></div>';
$tpl_main = str_replace('<spoon_header>', $tmp_header, $tpl_main);
// END SUBST - <spoon_header>
...
?>
<link rel="stylesheet" type="text/css" href="style/<?php echo $pun_user['style'].'_IE.css' ?>" />
<?php
}
if (defined('PUN_ADMIN_CONSOLE'))
	echo '<link rel="stylesheet" type="text/css" href="style/imports/base_admin.css" />'."\n";
?>
<meta name="keywords" content="spoon, hosting, free, direct admin, installatron, new zealand" />
<meta name="description" content="SPOON.net.nz http://www.spoon.net.nz" />
<?php
