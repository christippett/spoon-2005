...
<?php endif; ?>
<?php if ($is_admin || $pun_config['p_mod_ban_users'] == '1'): ?>
...
<?php endif; ?>
		...
		<h2 class="block2"><span>SPOON menu</span></h2>
		<div class="box">
			<div class="inbox">
				<ul>
<?php if ($is_admin): ?>	
					<li<?php if ($page == 'listfree') echo ' class="isactive"'; ?>><a href="admin_free.php">SPOON Free</a></li>
<?php endif; ?>		
<?php if ($is_admin): ?>	
					<li<?php if ($page == 'recurring') echo ' class="isactive"'; ?>><a href="admin_recurring.php">Recurring</a></li>
<?php endif; ?>				
