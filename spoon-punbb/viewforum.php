...
if (($cur_forum['post_topics'] == '' && $pun_user['g_post_topics'] == '1') || $cur_forum['post_topics'] == '1' || $is_admmod)
	$post_link = "<div class=\"post\"><a href=\"post.php?fid=".$id."\">".$lang_forum['Post topic']."</a></div>";
else
	$post_link = "<div class=\"post\"><a href=\"post.php?fid=".$id."\">".$lang_forum['Post topic']."</a></div>";
...
<div class="linkst">
	<div class="inbox">
<?php 
if (!paginate($num_pages, $p, 'viewforum.php?id='.$id) == 1)
	echo "\t\t<div class=\"pagelinks\">".$paging_links."</div>\n";
?>
		<ul><li><a href="forum.php"><?php echo $lang_common['Index'] ?></a>&nbsp;</li><li>-&nbsp;<?php echo pun_htmlspecialchars($cur_forum['forum_name']) ?></li></ul>
...
?>
				<tr>
					<td class="tcl" colspan="3"><?php echo $lang_forum['Empty forum'] ?></td>
				</tr>
<?php
