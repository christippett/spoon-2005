...
if ($cur_topic['closed'] == '0')
{
	if (($cur_topic['post_replies'] == '' && $pun_user['g_post_replies'] == '1') || $cur_topic['post_replies'] == '1' || $is_admmod)
		$post_link = '<div class="post"><a href="post.php?tid='.$id.'">'.$lang_topic['Post reply'].'</a></div>';
	else
		$post_link = '<div class="post">'.$lang_topic['Topic closed'].'</div>';
}
else
{
	$post_link = '<div class="post">'.$lang_topic['Topic closed'].'</div>';
...
<div class="linkst">
	<div class="inbox">
<?php
if (!paginate($num_pages, $p, 'viewtopic.php?id='.$id) == 1)
...
<div id="p<?php echo $cur_post['id'] ?>" class="blockpost<?php echo $vtbg ?><?php if (($post_count + $start_from) == 1) echo ' firstpost'; ?>">
	...
	<div class="box">
		<div class="inbox">
			<div class="postleft">
				<dl>
					<dt class="username"><?php echo $username ?></dt>
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset txtarea">
						...
						<label><textarea name="req_message" rows="7" cols="50" tabindex="1"></textarea>
						</label>
						<ul class="bblinks">
